    ...
    >
      ...
      <Box>
        ...
        <p>
          ...
          harmoniously. It fast and easy to use. You can save the audio file in
          any format (codec parameters are configured) This is serverless app.
          Your files does not leave your device use{" "}
          <mark>Region</mark> tool to mark the trim section
        </p>
      </Box>
